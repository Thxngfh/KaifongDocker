...
export default function ExecutivePage() {
  ...
  const kpiDefs = kpi ? [
    ...
    {
      label: <span>SLA สำเร็จ<InfoTip text="SLA คือระยะเวลามาตรฐานที่กำหนดไว้สำหรับแก้ไขเรื่องร้องเรียนแต่ละประเภทให้เสร็จ ถ้าทำไม่ทันเวลาที่กำหนดจะถือว่า 'เกิน SLA'" /></span>,
